...
//using WebBanSach.Areas.Admin.CommandPattern.Commands;
...
//        {
//            _commandHandler = new BookCommandHandler(BSDBContext.Instance, Server);
//        }
...
//        {
//            var adminId = Session["LoginAdmin"] as int?;
//          if(adminId.HasValue)  return adminId.Value;
//            return 1;
